...
/**
 * PrepaidSupplementNotifyModel Class Doc Comment.
 *
 * @category Class
 * @description 预付补差回调对象
 * @author   Tencent Business Enterprise Pay Team
 * @see     https://business.tenpay.com
 ...
 */
class PrepaidSupplementNotifyModel implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PrepaidSupplementNotifyModel';
    ...
    protected static $openAPITypes = [
        ...
        'event_content'    => '\Entpay\Mse\Client\Api\PrepaidSupplement',
    ];
     ...
     * Gets event_content.
     *
     * @return \Entpay\Mse\Client\Api\PrepaidSupplement|null
     */
     ...
     * Sets event_content.
     *
     * @param \Entpay\Mse\Client\Api\PrepaidSupplement|null $event_content event_content
     *
     * @return self
     */

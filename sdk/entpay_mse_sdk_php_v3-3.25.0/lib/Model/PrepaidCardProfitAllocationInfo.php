<?php
/**
 * PrepaidCardProfitAllocationInfo.
 *
 * @category Class
...
/**
 * PrepaidCardProfitAllocationInfo Class Doc Comment.
 *
 * @category Class
 * @description 分账信息
 * @author   Tencent Business Enterprise Pay Team
 ...
 */
class PrepaidCardProfitAllocationInfo implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PrepaidCardProfitAllocationInfo';
     ...
     * Sets allocations.
     *
     * @param \Entpay\Mse\Client\Model\PrepaidTradeAllocationParamItem[] $allocations 分账接收方信息
     *
     * @return self
     */

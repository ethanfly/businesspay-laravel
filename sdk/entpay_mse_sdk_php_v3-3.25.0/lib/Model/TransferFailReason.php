...
/**
 * TransferFailReason Class Doc Comment.
 *
 * @category Class
 * @description 失败原因
 * @author   Tencent Business Enterprise Pay Team
 ...
 */
class TransferFailReason implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'TransferFailReason';

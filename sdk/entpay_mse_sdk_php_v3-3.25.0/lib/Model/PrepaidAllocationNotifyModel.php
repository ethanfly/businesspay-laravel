...
/**
 * PrepaidAllocationNotifyModel Class Doc Comment.
 *
 * @category Class
 * @description 预付分账回调对象
 * @author   Tencent Business Enterprise Pay Team
 * @see     https://business.tenpay.com
 ...
 */
class PrepaidAllocationNotifyModel implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PrepaidAllocationNotifyModel';
    ...
    protected static $openAPITypes = [
        ...
        'event_content'    => '\Entpay\Mse\Client\Api\PrepaidTradeAllocation',
    ];
     ...
     * Gets event_content.
     *
     * @return \Entpay\Mse\Client\Api\PrepaidTradeAllocation|null
     */
     ...
     * Sets event_content.
     *
     * @param \Entpay\Mse\Client\Api\PrepaidTradeAllocation|null $event_content event_content
     *
     * @return self
     */

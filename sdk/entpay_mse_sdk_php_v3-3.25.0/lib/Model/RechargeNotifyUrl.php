...
/**
 * RechargeNotifyUrl Class Doc Comment.
 *
 * @category Class
 * @description 充值异步回调信息
 * @author   Tencent Business Enterprise Pay Team
 * @see     https://business.tenpay.com
 ...
 */
class RechargeNotifyUrl implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'RechargeNotifyUrl';
    ...
    protected static $openAPITypes = [
        ...
        'front_callback_url' => '\Entpay\Mse\Client\Model\PrepaidCardRechargeFrontCallbackUrl',
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if (null === $this->container['front_callback_url']) {
            $invalidProperties[] = "'front_callback_url' can't be null";
        }
     ...
     *
     * @param string $server_notify_url 后端充值结果通知url
     *
     * @return self
     */
     ...
     *
     * @return \Entpay\Mse\Client\Model\PrepaidCardRechargeFrontCallbackUrl
     */
     ...
     *
     * @param \Entpay\Mse\Client\Model\PrepaidCardRechargeFrontCallbackUrl $front_callback_url front_callback_url
     *
     * @return self
     */

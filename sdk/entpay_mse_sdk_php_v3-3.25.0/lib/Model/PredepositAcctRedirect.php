...
/**
 * PredepositAcctRedirect Class Doc Comment.
 *
 * @category Class
 * @description 预存款账户mp充值链接响应参数
 * @author   Tencent Business Enterprise Pay Team
 * @see     https://business.tenpay.com
 ...
 */
class PredepositAcctRedirect implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PredepositAcctRedirect';

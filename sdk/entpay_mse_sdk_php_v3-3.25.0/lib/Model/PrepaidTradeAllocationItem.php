...
/**
 * PrepaidTradeAllocationItem Class Doc Comment.
 *
 * @category Class
 * @description 分账结果列表
 * @author   Tencent Business Enterprise Pay Team
 ...
 */
class PrepaidTradeAllocationItem implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PrepaidTradeAllocationItem';
     ...
     *
     * @param string $receiver_ent_id 分账接收方企业ID
     *
     * @return self
     */
     ...
     *
     * @param string $receiver_merchant_name 分账接收方企业名称
     *
     * @return self
     */

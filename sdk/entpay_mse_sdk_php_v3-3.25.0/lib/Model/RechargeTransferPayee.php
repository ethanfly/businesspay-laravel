...
/**
 * RechargeTransferPayee Class Doc Comment.
 *
 * @category Class
 * @description 充值调拨收款方，即用户的预付卡信息
 * @author   Tencent Business Enterprise Pay Team
 * @see     https://business.tenpay.com
 ...
 */
class RechargeTransferPayee implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'RechargeTransferPayee';

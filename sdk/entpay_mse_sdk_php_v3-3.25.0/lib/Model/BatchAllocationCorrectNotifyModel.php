<?php
/**
 * BatchAllocationCorrectNotifyModel.
 *
 * @category Class
...
/**
 * BatchAllocationCorrectNotifyModel Class Doc Comment.
 *
 * @category Class
 * @description 批量分账回退回调对象
 * @author   Tencent Business Enterprise Pay Team
 * @see     https://business.tenpay.com
 ...
 */
class BatchAllocationCorrectNotifyModel implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'BatchAllocationCorrectNotifyModel';
    ...
    protected static $openAPITypes = [
        ...
        'event_content'    => '\Entpay\Mse\Client\Api\BatchProfitAllocationCorrect',
    ];
     ...
     * Gets event_content.
     *
     * @return \Entpay\Mse\Client\Api\BatchProfitAllocationCorrect|null
     */
     ...
     * Sets event_content.
     *
     * @param \Entpay\Mse\Client\Api\BatchProfitAllocationCorrect|null $event_content event_content
     *
     * @return self
     */

...
/**
 * RechargeTransferPayeeRsp Class Doc Comment.
 *
 * @category Class
 * @description 充值调拨收款方预付卡信息
 * @author   Tencent Business Enterprise Pay Team
 * @see     https://business.tenpay.com
 ...
 */
class RechargeTransferPayeeRsp implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'RechargeTransferPayeeRsp';

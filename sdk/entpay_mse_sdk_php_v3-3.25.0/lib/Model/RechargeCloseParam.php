...
/**
 * RechargeCloseParam Class Doc Comment.
 *
 * @category Class
 * @description 充值关单请求参数
 * @author   Tencent Business Enterprise Pay Team
 * @see     https://business.tenpay.com
 ...
 */
class RechargeCloseParam implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'RechargeCloseParam';

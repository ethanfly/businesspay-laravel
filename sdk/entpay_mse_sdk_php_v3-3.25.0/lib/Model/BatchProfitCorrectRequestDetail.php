<?php
/**
 * BatchProfitCorrectRequestDetail.
 *
 * @category Class
...
/**
 * BatchProfitCorrectRequestDetail Class Doc Comment.
 *
 * @category Class
 * @description 批量分账回退请求详情
 * @author   Tencent Business Enterprise Pay Team
 * @see     https://business.tenpay.com
 ...
 */
class BatchProfitCorrectRequestDetail implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'BatchProfitCorrectRequestDetail';

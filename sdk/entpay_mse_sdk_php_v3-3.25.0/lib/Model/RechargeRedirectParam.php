...
/**
 * RechargeRedirectParam Class Doc Comment.
 *
 * @category Class
 * @description 跳转请求参数
 * @author   Tencent Business Enterprise Pay Team
 ...
 */
class RechargeRedirectParam implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'RechargeRedirectParam';

...
/**
 * IndividualInfo Class Doc Comment.
 *
 * @category Class
 * @description 个人信息
 * @author   Tencent Business Enterprise Pay Team
 ...
 */
class IndividualInfo implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'IndividualInfo';
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['id_card_no']) > 18)) {
        ...
        if (null === $this->container['phone_no']) {
            $invalidProperties[] = "'phone_no' can't be null";
        }
        if ((mb_strlen($this->container['phone_no']) > 32)) {
            $invalidProperties[] = "invalid value for 'phone_no', the character length must be smaller than or equal to 32.";
        }

        if ((mb_strlen($this->container['phone_no']) < 1)) {
            $invalidProperties[] = "invalid value for 'phone_no', the character length must be bigger than or equal to 1.";
        }

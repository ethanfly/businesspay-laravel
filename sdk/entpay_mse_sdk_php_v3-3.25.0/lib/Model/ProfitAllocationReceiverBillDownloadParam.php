<?php
/**
 * ProfitAllocationReceiverBillDownloadParam.
 *
 * @category Class
...
/**
 * ProfitAllocationReceiverBillDownloadParam Class Doc Comment.
 *
 * @category Class
 * @author   Tencent Business Enterprise Pay Team
 * @see     https://business.tenpay.com
 ...
 */
class ProfitAllocationReceiverBillDownloadParam implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ProfitAllocationReceiverBillDownloadParam';
    ...
    protected static $openAPITypes = [
        'bill_date'        => 'string',
        'bill_type'        => '\Entpay\Mse\Client\Model\ProfitAllocationReceiverBillTypeEnum',
        'ent_id'           => 'string',
     ...
     * Gets bill_type.
     *
     * @return \Entpay\Mse\Client\Model\ProfitAllocationReceiverBillTypeEnum|null
     */
     ...
     * Sets bill_type.
     *
     * @param \Entpay\Mse\Client\Model\ProfitAllocationReceiverBillTypeEnum|null $bill_type bill_type
     *
     * @return self
     */

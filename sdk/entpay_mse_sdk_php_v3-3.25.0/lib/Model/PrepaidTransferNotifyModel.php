...
/**
 * PrepaidTransferNotifyModel Class Doc Comment.
 *
 * @category Class
 * @description 预付定向转账回调对象
 * @author   Tencent Business Enterprise Pay Team
 * @see     https://business.tenpay.com
 ...
 */
class PrepaidTransferNotifyModel implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PrepaidTransferNotifyModel';
    ...
    protected static $openAPITypes = [
        ...
        'event_content'    => '\Entpay\Mse\Client\Api\PrepaidTransfer',
    ];
     ...
     * Gets event_content.
     *
     * @return \Entpay\Mse\Client\Api\PrepaidTransfer|null
     */
     ...
     * Sets event_content.
     *
     * @param \Entpay\Mse\Client\Api\PrepaidTransfer|null $event_content event_content
     *
     * @return self
     */

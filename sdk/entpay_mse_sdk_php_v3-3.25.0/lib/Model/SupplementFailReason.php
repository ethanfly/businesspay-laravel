...
/**
 * SupplementFailReason Class Doc Comment.
 *
 * @category Class
 * @description 失败原因
 * @author   Tencent Business Enterprise Pay Team
 ...
 */
class SupplementFailReason implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SupplementFailReason';

...
/**
 * WithdrawTransferPayeeRsp Class Doc Comment.
 *
 * @category Class
 * @description 提现调拨收款方
 * @author   Tencent Business Enterprise Pay Team
 ...
 */
class WithdrawTransferPayeeRsp implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'WithdrawTransferPayeeRsp';

...
/**
 * DepositoryBank Class Doc Comment.
 *
 * @category Class
 * @description 支持银行信息
 * @author   Tencent Business Enterprise Pay Team
 ...
 */
class DepositoryBank implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DepositoryBank';
